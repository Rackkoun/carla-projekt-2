...
class Draw_Box_On_Image:
    ...
    def draw_box_1(self,img,p1,p2):

        border=1

        new_image=cv2.rectangle(img, p1,p2,(0,255,0),border)
    ...
    def main(self):
        ...
        image_name_1="rchud.jpeg"

        image_array_1 = cv2.imread(image_name_1)

        p1=(367,225)
        p2=(592,468)

        my_new_image_array_1= self.draw_box_1(image_array_1,p1,p2)

        self.show_box(my_new_image_array_1)
