...
class Toplevel1:
    ...
    def loadFiles(self):
        a=Main_Window_support.Checkbutton1_Var.get() #check if original is selected
        b=Main_Window_support.Checkbutton2_Var.get() #check if Treated is selected
        c=Main_Window_support.Checkbutton3_Var.get() #check if Json is selected
